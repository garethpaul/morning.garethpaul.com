...
work = 'https://routes.tomtom.com/lbs/services/route/1/' + settings.home_pos + ':' + settings.work_pos + '/Quickest/json/1e2099c7-eea9-476b-a\
...
home = 'https://routes.tomtom.com/lbs/services/route/1/'+ settings.work_pos + ':' + settings.home_pos + '/Quickest/json/1e2099c7-eea9-476b-aac9-b20dc7100af1;language=en;avoidTraffic=true;includeTraffic=true;day=today;time=now;iqRoutes=2;trafficModelId=1358732719560;map=basic'
...
def getDelay(url):
    ...
    request.add_header('Referer', 'https://routes.tomtom.com/')
